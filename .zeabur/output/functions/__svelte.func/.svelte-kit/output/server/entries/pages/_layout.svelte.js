import { c as create_ssr_component, a as add_attribute, o as onDestroy, b as add_styles, e as escape, v as validate_component, m as missing_component, d as spread, f as escape_object, g as merge_ssr_styles, h as subscribe, i as each } from "../../chunks/ssr.js";
...
const Analytics = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-12zg2s3_START --><script charset="UTF-8" id="LA_COLLECT" src="//sdk.51.la/js-sdk-pro.min.js" data-svelte-h="svelte-12w959f"><\/script><script data-svelte-h="svelte-6uxy2l">if (typeof __AnalyTimer == 'undefined') {
			let __AnalyTimer = setInterval(() => {
				if (!LA || !LA.init) {return;}

				LA.init({id:"KEIxrFsbADmTVb9W",ck:"KEIxrFsbADmTVb9W"});
				clearInterval(__AnalyTimer);
			}, 500);
		}
	<\/script><script type="text/javascript" data-svelte-h="svelte-1dr1a66">(function(c,l,a,r,i,t,y){
				c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};
				t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;
				y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
		})(window, document, "clarity", "script", "mabrwvk2kw");<\/script><!-- HEAD_svelte-12zg2s3_END -->`, ""}`;
});
let timeoutAction;
let timeoutEnable;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`${validate_component(Analytics, "Analytics").$$render($$result, {}, {}, {})}`} ${validate_component(Toaster, "Toaster").$$render($$result, {}, {}, {})} ${validate_component(Mode_watcher, "ModeWatcher").$$render($$result, {}, {}, {})} ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
