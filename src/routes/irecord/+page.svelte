<script lang='ts'>
  ...
  import {
    IconPhotoUp, IconFileUpload, IconX
...
on:dragenter={e=>{dragEnter = true;}}>
  ...
  gap-3 w-[30rem] px-8 max-w-full'>
    <label class="form-control w-full">
      ...
      <textarea class="textarea textarea-bordered min-h-[3rem] h-[4rem] w-full" 
          placeholder='' bind:value={recorder.imgAlt} maxlength='512'></textarea>
    </label>
